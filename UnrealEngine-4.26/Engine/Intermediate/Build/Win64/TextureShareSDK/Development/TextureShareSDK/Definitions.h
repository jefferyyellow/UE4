...
#define TEXTURE_SHARE_SDK_DLL 1
...
#define CORE_API 
#define TRACELOG_API 
#define TEXTURESHARECORE_RHI 0
#define TEXTURESHARELIB_PLATFORM_WINDOWS 1
#define TEXTURESHARELIB_USE_D3D11 1
#define TEXTURESHARELIB_USE_D3D12 1
#define TEXTURESHARELIB_PLATFORM Windows
#define TEXTURESHARECORE_API 
#define TEXTURESHARESDK_API 
